 ...
 * previous drawing beneath the pad — onion skin for animating poses. `stage`
 * renders beneath everything at full strength — a fixture (like the wordmark)
 * that the doodle is drawn on and around. */
