# DOOEY frontend — Expo / React Native

The app: iOS, Android and web from one codebase.
...
PocketBase must be running (`backend/pocketbase.exe serve` from the repo root). The API
