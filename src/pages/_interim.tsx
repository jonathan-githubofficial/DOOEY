 ...
 * page: /calendar -> 5.1, /boards -> 7.1, /projects -> 6.1, /style -> 3.4. Do NOT build product
 * UI here. The `data-testid` is the @l3 dock spec's "target rendered" assertion hook. */
...
export function InterimStyle() {
  return <InterimSpace title="Style" testid="page-style" />;
}
